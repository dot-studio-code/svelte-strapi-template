...
export interface ApiFooterMenuFooterMenu extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    menu: Schema.Attribute.Component<'menus.menu', true> &
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    contentBlocks: Schema.Attribute.DynamicZone<
      ['content-blocks.hero', 'content-blocks.text', 'content-blocks.river']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'General site-wide settings and metadata.';
  ...
  attributes: {
    ...
    fallbackOpenGraph: Schema.Attribute.Component<'seo.open-graph', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    logoDarkMode: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    siteVersion: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
